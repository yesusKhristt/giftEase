...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div
                style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;border: 1px solid #af5ea148; padding:20px;border-radius:30px;margin-top:20px;">
