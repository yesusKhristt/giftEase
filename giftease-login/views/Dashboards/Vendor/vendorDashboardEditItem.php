                ...
                <form>
                    <table class="table">
                        <tr>
                            ...
                            <td colspan="2">
                                <input type="text" id="titile" name="title" placeholder="Title">
                            </td>
                        </tr>
                        <tr>
                            <td class="subtitle">Product Category</td>
                            <td><select id="fruit" name="fruit" style="width:80%">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <input type="number" id="quantity" name="quantity" placeholder="Price" min="1">
                            </td>
                        </tr>
                        <tr>
