    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            <div class="sidebar-header">
                <h2 class="logo">
                    <span class="gift">gift</span>Ease
                </h2>
            </div>
            ...
            <nav class="sidebar-nav">
                <ul class="nav-list">
                    ...
                    <li>
                        <a href="?action=dashboard&type=vendor&level=messages" class="nav-item">
                            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="client-name">Kasun Silva</td>
                                        <td class="cost">$35.00</td>
                                        <td>2025-08-03</td>
                                        <td>2025-08-08</td>
                                        <td><span class="badge badge-due-soon">Due Soon</span></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <button class="view-btn">
                                        ...
                                        <td class="client-name">Nimal Fernando</td>
                    ...
                    <div class="summary-card">
                        <div class="summary-content">
                            <div class="summary-text">
                                ...
                                <p class="summary-value primary">4</p>
                            </div>
                    ...
                    <div class="summary-card">
                        <div class="summary-content">
                            <div class="summary-text">
                                ...
                                <p class="summary-value primary">$150.00</p>
                            </div>
                            <svg class="summary-icon primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z">
