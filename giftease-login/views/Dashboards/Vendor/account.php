        ...
        <div class="main-content">
            ...
            <div class="cardColour">
                ...
                <div class="profile-section">
                    <a href="?controller=vendor&action=dashboard/updateProfilePicture">
            ...
            <div class="card">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <div type="tel" class="form-input">
                            <?php echo htmlspecialchars($user2['shopName']); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div type="tel" class="form-input">
                            <?php echo htmlspecialchars($user2['address']); ?>
                        </div>
                    </div>
                </div>
                <div style="display: flex; gap: 15px;">
                    <a href="?controller=vendor&action=dashboard/editProfile/primary" class="btn1">
                        Update Profile
                    </a>
                    <a href="?controller=vendor&action=dashboard/deleteProfile" class="btn1">
                        Delete Profile
                    </a>
                </div>
            </div>
