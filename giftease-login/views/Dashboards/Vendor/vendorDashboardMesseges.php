...
<body>
    <div class="dashboard-container">
        <div class="sideBar">
            ...
            <ul>
                <li onclick="location.href='?action=dashboard&type=vendor&level=primary'">Orders</li>
                <li onclick="location.href='?action=dashboard&type=vendor&level=inventory'">Inventory</li>
                <li class="active">Messages</li>
                <li onclick="location.href='?action=dashboard&type=vendor&level=analysis'">Analysis</li>
            </ul>
        </div>
        ...
        <div class="main">
            <div class="client-list">
                ...
                <p class="active" onclick="selectClient('Thenuka')">Thenuka</p>
            ...
            <div class="message-box">
                ...
                <div class="message-history" id="messageHistory">
                    ...
                    <div class="message vendor">Sure, please confirm the new color.</div>
                    <div class="message client">I'd like it in royal blue instead of red.</div>
                    <div class="message vendor">Perfect! I'll update your order. The royal blue wrap will look great.
                    </div>
                    <div class="message client">Thank you! When will it be ready?</div>
                    <div class="message vendor">It should be ready by tomorrow evening. I'll send you a photo once it's
                        done.</div>
                </div>
            ...
            <div class="client-details">
                <div class="client-name" id="clientName">Thenuka Ranasinghe</div>
                <p id="orderDeadline">Order Deadline: 2025-08-10</p>
                <p id="orderStatus">Status: In Progress</p>
                <p id="orderValue">Order Value: $125.00</p>
                <button class="blue" onclick="viewOrder()">View Order</button>
                <button class="orange" onclick="cancelOrder()">Cancel Order</button>
            </div>
        </div>
    </div>
