                ...
                <div class="item-content">
                    <div class="item-header">
                        <div>
                            ...
                            <p class="gallery-description">Beautiful handwritten messages on premium cardstock with
                ...
                <div class="item-content">
                    <div class="item-header">
                        <div>
                            ...
                            <p class="gallery-description">These styles bring the outdoors in and are perfect for a cozy, handmade feel.  </p></br>
                ...
                <div class="item-content">
                    <div class="item-header">
                        <div>
                            ...
                            <p class="gallery-description">These are for when you want the wrapping to be part of the fun and tell a story. </p></br>
                            <h4> Customer rating: 4/5 stars.</h4>
                        </div>
                    </div>
                    <div class="item-details">
