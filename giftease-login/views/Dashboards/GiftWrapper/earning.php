                ...
                <div class="stats-grid" style="margin-bottom: 32px;">
                        <div class="card" style="grid-column: span 2;">
                            <div style="text-align: center; padding: 20px;">
                                <div style="font-size: 3rem; font-weight: bold; background: linear-gradient(135deg, #e91e63, #fed2ed); -webkit-background-clip: text; -webkit-text-fill-color: transparent; margin-bottom: 8px;">$1,847</div>
