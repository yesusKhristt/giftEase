      ...
      <?php foreach ($orders as $row): ?>
        <div class="notification-item unread" data-notification-id="1">
          ...
          <div class="notification-content">
            ...
            <div class="notification-text">You have been assigned order DEL-<?= htmlspecialchars($row['id']) ?> for
              delivery today.</div>
            ...
            <a class='btn1' href='?controller=giftWrapper&action=dashboard/acceptOrder/{$row['id']}'>Accept</a>
          </div>";
            }
            ?>
          </div>
