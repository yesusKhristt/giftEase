                    ...
                    ?>
                        <div class="staff-card <?php echo $row['verified'] ? 'verified' : 'pending'; ?>">
                            ...
                            <div class="staff-actions">
                                <?php if ($row['verified']): ?>
                                    <a class="btn-unverify" href="?controller=admin&action=dashboard/deliveryman/unverify/<?php echo htmlspecialchars($row['id']); ?>">
                                        <i class="fas fa-times"></i> Unverify
                                    </a>
                                <?php else: ?>
                                    <a class="btn-verify" href="?controller=admin&action=dashboard/deliveryman/verify/<?php echo htmlspecialchars($row['id']); ?>">
