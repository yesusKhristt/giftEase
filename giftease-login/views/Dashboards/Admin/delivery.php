    ...
    <div class="main-content">
      <section id="customers" class="page active">
        <div class="page-header">
          ...
          <p class="subtitle">Manage Delivery Partner Accounts</p>
        </div>
            ...
            <div class="staff-card <?php echo $delivery['verified'] ? 'verified' : 'pending'; ?>">
              ...
              <div class="staff-header">
                <div class="staff-info">
                  ...
                  <p class="shop-name"><i class="fas fa-truck"></i>Vehicle: <?php echo htmlspecialchars($delivery['vehiclePlate']); ?></p>
                </div>
                <div class="staff-status">
                  <span class="status-badge <?php echo $delivery['verified'] ? 'status-verified' : 'status-pending'; ?>">
                    <?php echo $delivery['verified'] ? 'Verified' : 'Pending'; ?>
                  </span>
                </div>
              </div>
              ...
              <div class="staff-details">
                ...
                <p><strong>Status:</strong> <?php echo ucfirst($delivery['status']); ?></p>
              </div>
