...
<body class="orange">
  <div class="container center">
    <div class="login-container">
      <p class="subHeading blueT">Gift Wrapper</p>
      ...
      <form method="POST" action="?type=giftWrapper&action=signup" class="center" id="signupForm">
        ...
        <a href="?action=login&type=giftWrapper" class="btn">Already have an account? Sign in</a>
      </form>
      <script>
