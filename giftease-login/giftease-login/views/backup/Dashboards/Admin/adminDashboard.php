  ...
  <body class="body">
    <div class="container">
      ...
      <aside class="sidebar" id="sidebar" aria-label="Sidebar Navigation">
        <h2 class="brand-side">
          <span class="brand-line">🎁 GiftEase</span>
          <span>Online Shopping & Wrapping</span>
        </h2>
        <ul aria-label="Main menu">
          <li class="menu-item active" data-page="dashboard"><span class="mi">📊</span> <span class="mi-label">Dashboard</span></li>
          <li class="menu-item" data-page="items"><span class="mi">📦</span> <span class="mi-label">Items</span></li>
          <li class="menu-item" data-page="vendors"><span class="mi">👔</span> <span class="mi-label">Vendors</span></li>
          <li class="menu-item" data-page="customers"><span class="mi">👥</span> <span class="mi-label">Customers</span></li>
          <li class="menu-item" data-page="deliveries"><span class="mi">🚚</span> <span class="mi-label">Deliveries</span></li>
          <li class="menu-item" data-page="reports"><span class="mi">📄</span> <span class="mi-label">Reports</span></li>
          <li class="menu-item" data-page="settings"><span class="mi">⚙️</span> <span class="mi-label">Settings</span></li>
          <li class="menu-item logout" data-page="logout"><span class="mi">↩️</span> <span class="mi-label">Logout</span></li>
        </ul>
      </aside>
        ...
        <main class="content" id="contentRoot">
          ...
          <section id="dashboard" class="page active" aria-labelledby="dashboard-title">
            ...
            <div class="quick-grid">
              <a class="quick ellipse items" data-page="items" role="button" aria-label="Go to Items">📦 <span>Items</span></a>
              <a class="quick ellipse vendors" data-page="vendors" role="button" aria-label="Go to Vendors">👔 <span>Vendors</span></a>
              <a class="quick ellipse customers" data-page="customers" role="button" aria-label="Go to Customers">👥 <span>Customers</span></a>
              <a class="quick ellipse deliveries" data-page="deliveries" role="button" aria-label="Go to Deliveries">🚚 <span>Deliveries</span></a>
            </div>
